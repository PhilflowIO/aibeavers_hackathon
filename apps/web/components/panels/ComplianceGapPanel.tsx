    ...
    <article className="flex h-full flex-col">
      ...
      <div className="rounded-xl border-2 border-red-300 bg-red-50 p-5 shadow-sm">
        <div className="flex items-start gap-3">
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-red-100 text-xl text-red-700">
            ⚠
          </span>
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-2 text-sm text-red-800">
              Pflichtfeld <code className="font-medium text-red-950">{gap.feld}</code> wurde im Gespräch
