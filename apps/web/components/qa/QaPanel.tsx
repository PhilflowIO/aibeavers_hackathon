...
export function QaPanel({ onAsk, loading = false }: QaPanelProps) {
  ...
  return (
    <section className="flex flex-col gap-3 rounded-lg border border-zinc-700/80 bg-zinc-950/40 p-4">
      <header>
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          disabled={loading}
          className="min-w-0 flex-1 rounded-md border border-zinc-700 bg-zinc-900 px-3 py-2 text-sm text-zinc-100 placeholder:text-zinc-600 focus:border-sky-500/60 focus:outline-none focus:ring-1 focus:ring-sky-500/40 disabled:opacity-50"
        />
        <button
          type="submit"
